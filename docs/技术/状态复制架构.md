...
Lag Compensation / Server Rewind已由[延迟补偿决定](延迟补偿与服务器回溯.md)完成；150 ms Max Rewind仍只是TEST参数。Session/Lobby、SDR/Transport、FishNet与Host Migration原则已由[网络运行与恢复](../治理/选型依据/网络运行与恢复.md)确认，具体channel、频率和性能仍须Spike。
