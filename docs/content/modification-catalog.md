...
depends_on: ["../gdd/field-modifications-and-effect-system.md"]
---

# Operation 改装目录与实验室实验
...
Operation采用WeaponModule/ToolModule/TeamProtocol；传统Relic及自动Fusion在Lab/未来Descent验证。底层统一ModificationDefinition，配件不自动变成隐藏被动Relic，不被未知Fusion吞掉。共享语义见[Build](../gdd/field-modifications-and-effect-system.md)。
