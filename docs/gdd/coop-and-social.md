...
抢拾取和并发花费归[经济](economy-and-support.md)；Cart失误归[世界](facility-systems-and-information-rules.md)；Team Ordnance归[战斗](combat-and-arsenal.md)。离队/被踢不能删除已提交世界后果。Public不能让网络Host获得资源优先。恶意反复丢关键物、耗Support仍可能伤害队伍，UI日志不足以保证解决，列入风险Gate。
