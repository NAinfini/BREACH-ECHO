---
doc_id: GOV-DECISIONS-HISTORY-20260905
doc_type: governance
stage: ARCHIVE
updated: 2026-09-05
owner_role: 设计决策维护
...
当前事故型代号候选为`断桥 / 回声 / 铁砧 / 寒蝉`，分别以安全规程、技术求知、生存账本和污染边界审视同一Operation代价；每人都有会帮助也会伤害队伍的优点、明确道德边界、个人收藏链和与另外三人的关系。真实姓名不设计、不显示，也不作为收藏谜底；年龄、性别呈现、外貌、服装、动作外观和配音选角延后。助手强烈建议角色只提供叙事身份，把现有Signature Active改为所有角色可选的配装战术模块；否则Seat会变成职业/强度选择。代号、人物内容与Active解绑均未获用户批准，完整候选见[角色v1](../../content/characters.md)。
...
| H37-19 Fusion discovery | C — Hybrid：知道强互动，不知道首次结果 | CANON；SRC-SSOT-2.0 §37 第19项 | [责任规则](../../gdd/modifications-and-effects.md) |
| H37-20 Fusion determinism | A — 条件满足结果确定 | CANON；SRC-SSOT-2.0 §37 第20项 | [责任规则](../../gdd/modifications-and-effects.md) |
| H37-21 Fusion consumption model | 用户纠正：A+B消失生成C | CANON；SRC-SSOT-2.0 §37 第21项 | [责任规则](../../gdd/modifications-and-effects.md) |
| H37-22 Fusion commit | A — 自动发生，Isaac-like | CANON；SRC-SSOT-2.0 §37 第22项 | [责任规则](../../gdd/modifications-and-effects.md) |
| H37-23 Fusion inheritance | C — Compatible preserve + recipe convert | CANON；SRC-SSOT-2.0 §37 第23项 | [责任规则](../../gdd/modifications-and-effects.md) |
...
| H37-33 Relic slots | Isaac式无限累计 | CANON；SRC-SSOT-2.0 §37 第33项 | [责任规则](../../gdd/modifications-and-effects.md) |
...
| 30Relic/6–10Fusion、继承、循环、可读性、Spell互作 | [Build](../../gdd/modifications-and-effects.md) | Lab验证后再扩大 |
