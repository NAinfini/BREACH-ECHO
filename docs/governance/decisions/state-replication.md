---
doc_id: DECISION-STATE-REPLICATION
doc_type: decision
stage: BASELINE
updated: 2026-09-05
owner_role: 网络与Gameplay架构负责人
canon_basis: "SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE；DECISION-HOST-AUTHORITY-COMMANDS；DECISION-FIXED-TICK-MULTIRATE"
depends_on: ["host-authority-and-gameplay-commands.md", "fixed-tick-and-multirate-simulation.md"]
---
...
DECISION-HOST-AUTHORITY-COMMANDS 已锁定 player-hosted authoritative listen server、Gameplay Command Replication 与 Client Prediction / Server Reconciliation；DECISION-FIXED-TICK-MULTIRATE 已锁定 60 Hz fixed authoritative simulation 与 multi-rate replication。下一项高返工风险问题是：Authority 已经算出的世界状态究竟如何高效、可恢复地投影给每个 Client。
...
NETREPL-001 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。

BREACH ECHO 的默认 Host → Client 复制模型采用：

> **快照 + 增量状态复制 + 可靠玩法事件 + 兴趣管理 + 休眠**
...
NETREPL-002 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-003 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-004 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-005 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-006 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-007 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-008 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE；依赖 DECISION-AGENT-FIRST-MOD-RUNTIME stable package identity 与 DECISION-HOST-AUTHORITY-COMMANDS Authority ownership。
...
NETREPL-009 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE；与 SIMTICK-007 一致。
...
NETREPL-010 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-011 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
NETREPL-012 · CANON · 来源：SRC-USER-2026-09-05-REPLICATION-ARCHITECTURE。
...
Lag Compensation / Server Rewind已由[延迟补偿决定](lag-compensation-and-server-rewind.md)完成；150 ms Max Rewind仍只是TEST参数。Session/Lobby、SDR/Transport、FishNet与Host Migration原则已由[网络运行与恢复](network-runtime-and-recovery.md)确认，具体channel、频率和性能仍须Spike。
