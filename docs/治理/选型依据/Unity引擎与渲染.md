...
updated: 2026-09-05
owner_role: 技术与产品负责人
canon_basis: SRC-USER-2026-09-05-UNITY-ENGINE-LOCK；SRC-USER-2026-09-05-UNITY-URP-GAMEOBJECT-FIRST；SRC-USER-2026-09-05-AI-AGENT-FIRST-STRUCTURE；官方Unity
  2026许可资料
depends_on:
  - 产品核心取舍依据.md
...
当前仍待验证/选择的Unity实现方向：
- 联网栈已确认为[Steam Lobby/SDR + FishNet + BREACH自有迁移协议](网络运行与恢复.md)；初始版本平台侧能力与公开Mod分发全部只走Steam。FishySteamworks和具体迁移参数仍须Spike，不维持多框架并行生产线。
...
[模拟架构](../../技术/模拟架构与性能合同.md)；[Modding与Agent工具链](../../技术/模块化产品公开能力与工具链.md)；[网络与持久化](../../技术/网络权威存档与版本固定.md)；[视觉方向](../../表现与资产/视觉方向与可识别性.md)；[平台与发行](../../制作/平台商业演示与发行关卡.md)。
...
AI-agent-first项目结构与Mod Runtime已由[Agent-first Mod Runtime](智能体优先工程结构与模组运行时.md)完成；Host Authority、Tick、Replication与Lag Compensation已分别由[Host Authority](../../技术/主机权威与玩法命令复制.md)、[固定Tick与多频模拟](../../技术/固定步进与多频率模拟.md)、[状态复制](../../技术/状态复制架构.md)和[延迟补偿](../../技术/延迟补偿与服务器回溯.md)完成。Provider/Transport、Session和Host Migration原则已由[网络运行与恢复](网络运行与恢复.md)确认，等待Spike。资产采购/license流程由[Asset Policy](../../表现与资产/资产采购来源与许可政策.md)接管，仍有OPEN项。
