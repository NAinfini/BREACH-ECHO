...
canon_basis: SRC-SSOT-2.0
  §4B、§37、§40、§42；最新Operation优先建议；SRC-USER-2026-09-05-FOUR-LIVING-FIELD-SQUAD-NONPROGRESSIVE-STORY
depends_on:
  - ../玩法/统一改装与效果系统.md
  - ../世界与叙事/世界观与正史圣经.md
---
...
未来规划保留，不能因不属于基础版而删除。公共行动恢复通往虚空兽等异族行星的路线后，才引入 Roguelike 深潜；具体构筑候选见[遗物与融合](深潜遗物与融合候选.md)。该入口条件的完整规则见本文件“行星端点与正史位置”，不要求基础版现在实现。
...
Descent不进入当前1.0承诺。内部[Combat Lab](../技术/模块化产品公开能力与工具链.md)只有10分钟、无任务、高密度奖励的第二消费者，用来证明Kernel没有焊死Operation及测试Proc；它不是公开Descent、完整三层内容或免费第二游戏，也不是当前必须先建的独立项目。

未来批准后流程为局前profile→Layer1保证构筑连接→层间选择/恢复→后续转化→终局/继续深潜→结果。共享数学、资源事务、融合、死亡规则只引用[Build](../玩法/统一改装与效果系统.md)、[经济](../玩法/资源回收额度与公共物资.md)、[生命](../玩法/生存倒地与失败恢复.md)。
...
DES-008 · DIRECTION · 来源：SRC-USER-2026-09-05-NODE-CLEARANCE-AND-PLANETARY-DESCENT；SRC-USER-2026-09-05-NODES-LORE-ONLY-DESCENT-COMMUNITY-EVENT；世界边界见[世界观NAR-030](../世界与叙事/世界观与正史圣经.md)。
...
DES-010 · DIRECTION · 来源：SRC-USER-2026-09-05-NODES-LORE-ONLY-DESCENT-COMMUNITY-EVENT；活动与进度责任见[Operation OPS-013](../玩法/系统化战术行动模式.md)和[进度PRG-013](../玩法/知识永久进度与壁垒.md)。
