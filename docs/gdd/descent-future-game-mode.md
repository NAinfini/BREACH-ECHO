...
depends_on: ["field-modifications-and-effect-system.md", "canonical-world-history-and-lore.md"]
---
...
未来批准后流程为局前profile→Layer1保证构筑连接→层间选择/恢复→后续转化→终局/继续深潜→结果。共享数学、资源事务、融合、死亡规则只引用[Build](field-modifications-and-effect-system.md)、[经济](economy-and-support.md)、[生命](survival-and-recovery.md)。
...
| 是否首发/是否制作 | 不进入基础1.0；未来另过制作Gate | 基础产品范围与生产交接基线 |
...
DES-008 · DIRECTION · 来源：SRC-USER-2026-09-05-NODE-CLEARANCE-AND-PLANETARY-DESCENT；SRC-USER-2026-09-05-NODES-LORE-ONLY-DESCENT-COMMUNITY-EVENT；世界边界见[世界观NAR-030](canonical-world-history-and-lore.md)。
...
DES-010 · DIRECTION · 来源：SRC-USER-2026-09-05-NODES-LORE-ONLY-DESCENT-COMMUNITY-EVENT；活动与进度责任见[Operation OPS-013](operation-game-mode.md)和[进度PRG-013](progression-and-bastion.md)。
