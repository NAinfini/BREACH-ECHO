...
depends_on: ["modifications-and-effects.md"]
---
...
AttackRoot 追踪一次因果攻击；Hit 表示合法命中；DamageEvent/Status/Reaction 由[Build系统](modifications-and-effects.md)解释。视觉后坐、镜头抖动与真实弹道分离。武器成本见[经济](economy-and-support.md)。
...
CMB-002 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；DDD-0013–0018；原规则历史保留于Git。
...
CMB-011 · CANON · 来源：SRC-USER-2026-09-04-FIRST-BUILDER-PROTOTYPES；引用[世界观NAR-010](narrative-bible.md)。

Prototype weapon的筑路者技术谱系由NAR-010唯一维护。战斗系统不得把“部分”扩大成全部，也不得在未确认前给具体武器指定原件、仿制、逆向工程或量产身份；这些身份不改变CMB-002对真实资源与机制作用的要求。

## 玩家流程

CMB-005 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。

识别威胁与掩体→选武器家族→预备/瞄准→提交攻击与资源→命中部位→反馈装甲/姿态/生命变化→决定续攻、换枪、冷却、近战或撤位。一次命中反馈必须能区分“没击中”“护甲有效”“打断”“击杀”，不能只有更大粒子。

## 状态与所有权

CMB-006 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。
...
CMB-007 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。

共用命中、伤害、装填和能力语义；模式只改资源供应与公开内容参数。武器卡声明射击方式、节奏、弹道、手感反馈、成本、范围、Tags、部位作用与可取消点。禁止靠不同模式悄悄改变同一攻击对同一材质的定义。

## 边界

CMB-008 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。
...
CMB-009 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。
...
CMB-012 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：SRC-USER-2026-09-04-ENERGY-EM-GUN-FAMILIES。
...
CMB-013 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；DDD-0013–0018；原规则历史保留于Git。
...
CMB-014 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：SRC-USER-2026-09-04-RESPONSIVE-GUNPLAY-CANCEL-WINDOWS。
...
CMB-016 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；DDD-0013–0018；原规则历史保留于Git。

Operation枪械核心已裁决。Staff 3/6法术和四主武器近战试验仅归Lab/FUTURE；Quick Melee、有限资源和已有动作纪律继续有效。该选择见DDD-0014，后续不再作为等待所有者选技术的OPEN。

## Team Ordnance：世界团队重资产

ORD-001 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：SRC-USER-2026-09-04-ORDNANCE-MISSIONS。
...
ORD-002 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。
...
ORD-003 · DECIDED · 来源：SRC-USER-2026-09-05-DELEGATED-DOCUMENT-FINALIZATION；授予决策权后采纳行为合同，数值/效果仍须TEST；原依据：来源：本轮系统扩写。
